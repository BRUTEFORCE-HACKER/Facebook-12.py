...
\033[1;91m☞ Auther     : tzyanonymous
\033[1;92m☞ WhatsApp   : 03232132362
\033[1;95m☞ YouTube    : https://youtu.be/QmT-jzG9idc
...
def mb():
	...
	if bm =='':
	    ...
	    psb('FACEBOOK ID:100064389556197✓')
	    psb('WellCome TO MED PENETRATE')
	    psb('Congratulations MED PENETRATE Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ kairu june')
	    psb('🔓Password ☆ anonymous12✓')
